...
L1551:  clc                                     ; 1551 18                       .
        !byte   $22                             ; 1552 22                       "
        !text   "CONFIGURE"                     ; 1553 43 4F 4E 46 49 47 55 52  CONFIGUR
                                                ; 155B 45                       E
        !byte   $22                             ; 155C 22                       "
        !text   " is not applicable"            ; 155D 20 69 73 20 6E 6F 74 20   is not 
                                                ; 1565 61 70 70 6C 69 63 61 62  applicab
                                                ; 156D 6C 65                    le
        !byte   $00,$18                         ; 156F 00 18                    ..
        !text   "to this version of GEOS KERNAL"; 1571 74 6F 20 74 68 69 73 20  to this 
...
; ----------------------------------------------------------------------------
        clc                                     ; 1661 18                       .
        !text   "Drive A"                       ; 1662 44 72 69 76 65 20 41     Drive A
        !byte   $00,$18                         ; 1669 00 18                    ..
        !text   "Drive B"                       ; 166B 44 72 69 76 65 20 42     Drive B
        !byte   $00,$18                         ; 1672 00 18                    ..
        !text   "Drive C"                       ; 1674 44 72 69 76 65 20 43     Drive C
        !byte   $00                             ; 167B 00                       .
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        clc                                     ; 179E 18                       .
        !text   "DMA for"                       ; 179F 44 4D 41 20 66 6F 72     DMA for
        !byte   $00,$22                         ; 17A6 00 22                    ."
        !text   "MoveData"                      ; 17A8 4D 6F 76 65 44 61 74 61  MoveData
...
; ----------------------------------------------------------------------------
        !byte   $18                             ; 17D8 18                       .
        !text   "RAM Reboot"                    ; 17D9 52 41 4D 20 52 65 62 6F  RAM Rebo
                                                ; 17E1 6F 74                    ot
        !byte   $00                             ; 17E3 00                       .
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        !byte   $18                             ; 18A5 18                       .
        !text   "RAM expansion: "               ; 18A6 52 41 4D 20 65 78 70 61  RAM expa
...
L19E4:  !byte   $18                             ; 19E4 18                       .
        !text   "Unable to save configuration:" ; 19E5 55 6E 61 62 6C 65 20 74  Unable t
                                                ; 19ED 6F 20 73 61 76 65 20 63  o save c
                                                ; 19F5 6F 6E 66 69 67 75 72 61  onfigura
                                                ; 19FD 74 69 6F 6E 3A           tion:
        !byte   $00,$18                         ; 1A02 00 18                    ..
        !text   "Can't find "                   ; 1A04 43 61 6E 27 74 20 66 69  Can't fi
                                                ; 1A0C 6E 64 20                 nd 
        !byte   $22                             ; 1A0F 22                       "
        !text   "CONFIGURE"                     ; 1A10 43 4F 4E 46 49 47 55 52  CONFIGUR
                                                ; 1A18 45                       E
        !byte   $22                             ; 1A19 22                       "
        !text   " file."                        ; 1A1A 20 66 69 6C 65 2E         file.
        !byte   $00,$00,$0E,$00,$00,$15,$00,$01 ; 1A20 00 00 0E 00 00 15 00 01  ........
        !text   "-"                             ; 1A28 2D                       -
        !byte   $1A                             ; 1A29 1A                       .
        !text   "@= file"                       ; 1A2A 40 3D 20 66 69 6C 65     @= file
        !byte   $00                             ; 1A31 00                       .
        !text   "disk"                          ; 1A32 64 69 73 6B              disk
        !byte   $00                             ; 1A36 00                       .
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        !text   "save configurat"               ; 1A4D 73 61 76 65 20 63 6F 6E  save con
                                                ; 1A55 66 69 67 75 72 61 74     figurat
L1A5C:  !text   "ion"                           ; 1A5C 69 6F 6E                 ion
        !byte   $00                             ; 1A5F 00                       .
        !text   "CONFIGURE info"                ; 1A60 43 4F 4E 46 49 47 55 52  CONFIGUR
                                                ; 1A68 45 20 69 6E 66 6F        E info
        !byte   $00                             ; 1A6E 00                       .
        !text   "quit"                          ; 1A6F 71 75 69 74              quit
        !byte   $00                             ; 1A73 00                       .
; ----------------------------------------------------------------------------
...
L1BB2:  !byte   $1B                             ; 1BB2 1B                       .
        ...
        !text   "No Drive"                      ; 1BC0 4E 6F 20 44 72 69 76 65  No Drive
        !byte   $00,$01,$CE,$1B,$B7,$07         ; 1BC8 00 01 CE 1B B7 07        ......
        !text   "1541"                          ; 1BCE 31 35 34 31              1541
        !byte   $00                             ; 1BD2 00                       .
        !text   "A"                             ; 1BD3 41                       A
        !byte   $D8,$1B,$FF,$07                 ; 1BD4 D8 1B FF 07              ....
        !text   "Shadowed 1541"                 ; 1BD8 53 68 61 64 6F 77 65 64  Shadowed
                                                ; 1BE0 20 31 35 34 31            1541
        !byte   $00,$81,$EB,$1B                 ; 1BE5 00 81 EB 1B              ....
        !text   "A"                             ; 1BE9 41                       A
        !byte   $08                             ; 1BEA 08                       .
        !text   "RAM 1541"                      ; 1BEB 52 41 4D 20 31 35 34 31  RAM 1541
        !byte   $00,$02,$F9,$1B,$DF,$07         ; 1BF3 00 02 F9 1B DF 07        ......
        !text   "1571"                          ; 1BF9 31 35 37 31              1571
        !byte   $00,$03,$03,$1C,$EF,$07         ; 1BFD 00 03 03 1C EF 07        ......
        !text   "1581"                          ; 1C03 31 35 38 31              1581
        !byte   $00                             ; 1C07 00                       .
        !text   "C"                             ; 1C08 43                       C
        !byte   $0D,$1C                         ; 1C09 0D 1C                    ..
        !text   " "                             ; 1C0B 20                        
        !byte   $08                             ; 1C0C 08                       .
        !text   "Dir Shadow 1581"               ; 1C0D 44 69 72 20 53 68 61 64  Dir Shad
                                                ; 1C15 6F 77 20 31 35 38 31     ow 1581
        !byte   $00,$82,$22,$1C                 ; 1C1C 00 82 22 1C              ..".
        !text   "s"                             ; 1C20 73                       s
        !byte   $08                             ; 1C21 08                       .
        !text   "RAM 1571"                      ; 1C22 52 41 4D 20 31 35 37 31  RAM 1571
        !byte   $00,$83                         ; 1C2A 00 83                    ..
        !byte   "0"                             ; 1C2C 30                       0
        !byte   $1C,$A5,$08                     ; 1C2D 1C A5 08                 ...
        !text   "RAM 1581"                      ; 1C30 52 41 4D 20 31 35 38 31  RAM 1581
; ----------------------------------------------------------------------------
        brk                                     ; 1C38 00                       .
